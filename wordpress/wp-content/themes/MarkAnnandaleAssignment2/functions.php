...
function game_reviews(){
	$query = new WP_Query(array('post_type' => 'game-reviews', 'posts_per_page' => 10));
...
function game_shortcode(){
	add_shortcode('game_shortcode', 'game_reviews');
}
add_action('init', 'game_shortcode');